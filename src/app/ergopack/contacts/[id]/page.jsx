/**
 * Contact Detail Page - Clean White Theme
 * 
 * Features:
...
// Status Config directly from list page for consistency
const STATUS_CONFIG = {
        ...
        <div className="min-h-screen bg-white text-black font-sans">
            ...
            <div className="sticky top-0 z-10 bg-white/80 backdrop-blur-md border-b border-gray-200 shadow-sm">
                <div className="max-w-5xl mx-auto px-4 py-3 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-xl font-bold text-gray-900">{contact.company_name}</h1>
                            {(() => {
                                const status = STATUS_CONFIG[contact.status] || STATUS_CONFIG.open;
                                return (
                                    <Badge className={`${status.bg} ${status.text} border ${status.border} text-xs capitalize mt-0.5 px-2 py-0.5`}>
            ...
            <div className="max-w-5xl mx-auto px-4 py-6">
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div className="lg:col-span-2 bg-white rounded-lg border border-[#ddd] p-6 shadow-sm space-y-5">
                        ...
                        <div className="space-y-2 pt-4 mt-4 border-t border-[#eee]">
                            ...
                            {presentationInfo?.hasPresentation ? (
                                <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 group hover:border-[#AD7D56]/30 transition-colors">
                                    <div className="flex items-center justify-between">
                                        <div className="flex items-center gap-3">
                                            <div className="w-10 h-10 rounded-lg bg-red-50 flex items-center justify-center shadow-sm">
                                                <FileText className="w-5 h-5 text-red-600" />
                                            </div>
                                            <div>
                                                <p className="text-sm text-gray-900 font-medium">{presentationInfo.fileName}</p>
                                        ...
                                        <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                                            <a
                                                ...
                                                className="inline-flex items-center justify-center w-8 h-8 rounded bg-white border border-gray-200 hover:bg-gray-50 text-gray-600 transition-colors shadow-sm"
                                                title="View"
                                            >
                                            ...
                                            <button
                                                ...
                                                className="inline-flex items-center justify-center w-8 h-8 rounded bg-white border border-gray-200 hover:bg-red-50 text-gray-400 hover:text-red-600 transition-colors shadow-sm"
                                                title="Delete"
                                            >
                                                <Trash2 className="w-4 h-4" />
                                            </button>
                                ...
                                <div
                                    ...
                                    className={cn(
                                        ...
                                        isDragging
                                            ...
                                            : "border-gray-200 hover:border-[#AD7D56] hover:bg-gray-50"
                                    )}
                                >
                                    {isUploadingPresentation ? (
                                        ...
                                        <>
                                            ...
                                            <label htmlFor="presentation-upload" className="cursor-pointer">
                                                <div className="flex flex-col items-center gap-2">
                                                    <div className="w-10 h-10 rounded-lg bg-gray-50 border border-gray-200 flex items-center justify-center group-hover:bg-white transition-colors">
                                                        <Upload className="w-5 h-5 text-gray-400 group-hover:text-[#AD7D56]" />
                                                    </div>
                                                    <div>
                                                        <p className="text-sm text-gray-700 font-medium">Drop PDF here or click to upload</p>
                                                        <p className="text-xs text-gray-400 mt-0.5">Max file size: 10MB</p>
                                                    </div>
                                                </div>
                                            </label>
                                        </>
                    ...
                    {/* Right - Activity */}
                    <div className="lg:col-span-1 bg-white rounded-lg border border-gray-200 shadow-sm flex flex-col h-[600px]">
                        <div className="p-4 border-b border-gray-100 flex items-center justify-between sticky top-0 bg-white z-10 rounded-t-lg">
                            <h2 className="text-xs uppercase tracking-wider text-gray-500 font-semibold">Activity Timeline</h2>
                            <Button
                                size="sm"
                                onClick={() => setShowActivityForm(!showActivityForm)}
                                className={cn(
                                    "h-7 text-xs px-3 shadow-none",
                                    showActivityForm
                                        ? "bg-gray-100 text-gray-600 hover:bg-gray-200"
                                        : "bg-[#AD7D56] hover:bg-[#8c6546] text-white"
                                )}
                            >
                        ...
                        {/* Add Activity Form */}
                        {showActivityForm && (
                            <div className="p-4 border-b border-gray-100 bg-gray-50 space-y-3 animation-slide-down">
                                        ...
                                        <button
                                            ...
                                            className={cn(
                                                ...
                                                newActivity.activityType === t.value
                                                    ? 'bg-[#AD7D56] text-white shadow-sm ring-2 ring-[#AD7D56]/20'
                                ...
                                <Input
                                    ...
                                    className="bg-white border-gray-200 text-sm focus:border-[#AD7D56] focus:ring-[#AD7D56]/10"
                                />
                                <Textarea
                                    ...
                                    rows={3}
                                    className="bg-white border-gray-200 text-sm resize-none focus:border-[#AD7D56] focus:ring-[#AD7D56]/10"
                                />
                                <div className="flex justify-end gap-2">
                                    <Button size="sm" variant="ghost" onClick={() => setShowActivityForm(false)} className="text-gray-500 h-8">
                                        Cancel
                                    </Button>
                                    <Button size="sm" onClick={handleAddActivity} className="bg-[#AD7D56] text-white hover:bg-[#8c6546] h-8">
                                        Save Activity
                                    </Button>
                                </div>
                            </div>
                            ...
                            {activities.length === 0 ? (
                                ...
                                activities.map((activity, index) => {
                                    ...
                                    switch (activity.activity_type) {
                                        case 'call': iconColor = "text-blue-600"; iconBg = "bg-blue-50 border-blue-100"; break;
                                        case 'email': iconColor = "text-orange-600"; iconBg = "bg-orange-50 border-orange-100"; break;
                                        case 'meeting': iconColor = "text-purple-600"; iconBg = "bg-purple-50 border-purple-100"; break;
                                        case 'status_change': iconColor = "text-amber-600"; iconBg = "bg-amber-50 border-amber-100"; break;
                                        case 'follow_up': iconColor = "text-teal-600"; iconBg = "bg-teal-50 border-teal-100"; break;
                                    }
                                    ...
                                    return (
                                        <div key={activity.id} className="relative pl-8 group">
                                            {/* Vertical Line */}
                                            {!isLast && (
                                                <div className="absolute left-[11px] top-8 bottom-[-24px] w-px bg-gray-200 group-hover:bg-gray-300 transition-colors" />
                                            )}

                                            {/* Icon Dot */}
                                            <div className={cn(
                                                "absolute left-0 top-0 w-6 h-6 rounded-full border flex items-center justify-center z-10 transition-all duration-300",
                                                iconBg,
                                            ...
                                            <div className="space-y-1">
                                                ...
                                                {activity.description && (
                                                    <div className="text-xs text-gray-600 bg-gray-50/50 p-2.5 rounded-md border border-gray-100/50 mt-1.5 leading-relaxed">
                                                        {activity.description}
                                                    </div>
                                                )}
